...
Twenty-five documents make up the catalog: this master index, the coverage ledger, and 23 workflow-area documents. **Twenty-one are delivered; the four marked *Outstanding* below are not yet written and are recorded in [Omissions](#omissions) with their frame and flow allocations.** Per-area flow and frame counts are held in one place only — the [Coverage assertion](_screenshot-index.md#coverage-assertion) table of the coverage index — so that the arithmetic has a single source of truth.
...
| [18-pricing-plans.md](18-pricing-plans.md) | Pricing & Plans — **Outstanding** | The pricing page and its plan cards, the feature-comparison table and its mixed cell types, per-column purchase and contact calls to action, the in-product plan chooser and paid-plan tour, and the upgrade and checkout journey |
| [19-brand-guidelines.md](19-brand-guidelines.md) | Brand Guidelines — **Outstanding** | The brand-centre site documented as a **page structure to rebuild with the next run's own brand** — its navigation grouping, the brand-values pages, the colour pages, the swatch-row anatomy with its four colour notations, and colour usage and application guidance. Observed values are placeholders, never requirements |
| [20-help-community.md](20-help-community.md) | Help & Community — **Outstanding** | The in-app help panel, raising and tracking a support request from the administration console, the help-centre home, search, articles with in-article navigation, the article-feedback form with its character counter and disabled submit, category browsing, contacting support, the changelog, the community marketing page, the community forum with its discussions, topics, questions and groups, the guidelines, and the certification programme with its questions |
...
| `C-TOP-BAR` | Top bar with history controls and help entry | [00-product-overview.md](00-product-overview.md) | 00, 02, 08, 09, 14, 15, 22 · planned: 20 |
| `C-SEARCH-ENTRY` | Search entry field and overlay trigger | [00-product-overview.md](00-product-overview.md) | 02, 08, 09, 10, 11, 13, 22 · planned: 17, 20 |
...
| `C-MODAL-SHELL` | Centred modal shell with title and dismiss control | [00-product-overview.md](00-product-overview.md) | 00, 01, 02, 03, 06, 07, 08, 09, 10, 13, 14, 15, 16, 21, 22 |
| `C-STEP-WIZARD` | Multi-step wizard with progress label and Back or Next | [00-product-overview.md](00-product-overview.md) | 01, 02 · planned: 18 |
| `C-DROPDOWN-MENU` | Dropdown and select menu with optional descriptions | [00-product-overview.md](00-product-overview.md) | 00, 01, 02, 03, 06, 07, 08, 09, 10, 11, 12, 13, 14, 15, 16, 21, 22 · planned: 17 |
...
| `C-TAB-BAR` | Tab bar, with optional per-tab counts | [00-product-overview.md](00-product-overview.md) | 02, 03, 04, 06, 08, 09, 10, 11, 12, 13, 14, 15, 16, 21, 22 · planned: 20 |
| `C-FILTER-CHIP` | Filter chip and chip-based filter bar | [00-product-overview.md](00-product-overview.md) | 02, 07, 08, 09, 11, 16, 21 · planned: 17 |
...
| `C-BANNER` | Inline and page-level banner, dismissible variants | [00-product-overview.md](00-product-overview.md) | 00, 01, 02, 06, 07, 08, 10, 11, 12, 13, 14, 15, 21, 22 · planned: 18 |
...
| `C-AVATAR` | Avatar, with facepile and stacked variants | [00-product-overview.md](00-product-overview.md) | 01, 02, 03, 04, 05, 06, 07, 08, 09, 10, 11, 12, 13, 14, 15, 16, 22 · planned: 17 |
...
| `C-EMPTY-STATE` | Empty state with illustration, heading and primary action | [00-product-overview.md](00-product-overview.md) | 01, 02, 03, 05, 07, 08, 09, 10, 12, 15, 16, 21, 22 · planned: 20 |
| `C-UPGRADE-GATE` | Upgrade badge, trial countdown and upsell strip | [00-product-overview.md](00-product-overview.md) | 00, 01, 02, 06, 07, 08, 09, 11, 13, 14, 15, 16, 21, 22 · planned: 18 |
| `C-DETAILS-PANE` | Details surface, as a centred modal or a docked pane | [00-product-overview.md](00-product-overview.md) | 00, 02, 04, 07, 08, 11, 13, 16 |
| `C-DATA-TABLE` | Data table with grouped rows and mixed cell types | [00-product-overview.md](00-product-overview.md) | 02, 06, 07, 08, 10, 11, 14, 15, 21, 22 · planned: 17, 18 |
...
| `C-MEDIA-PLAYER` | Audio and video player with scrubber and elapsed time | [00-product-overview.md](00-product-overview.md) | 03, 07, 16 · planned: 17 |
...
| `C-DATE-PICKER-POPOVER` | Month-grid date-picker popover | [00-product-overview.md](00-product-overview.md) | 01, 13, 21 |
| `C-STRENGTH-METER` | Password-strength meter | [00-product-overview.md](00-product-overview.md) | 01 |
| `C-INLINE-VALIDATION` | Inline field-level validation message | [00-product-overview.md](00-product-overview.md) | 01, 02, 03, 15 · planned: 18 |
| `C-PLAN-CARD` | Plan-choice card | [00-product-overview.md](00-product-overview.md) | 01 · planned: 18 |
| `C-CONTENT-CAROUSEL` | Paged content carousel | [00-product-overview.md](00-product-overview.md) | 11, 22 |
...
| `C-DISCLOSURE-CARD-LIST` | Disclosure-card list | [00-product-overview.md](00-product-overview.md) | 15 |
...
| `C-PAGER` | Pagination row | [00-product-overview.md](00-product-overview.md) | 09, 10, 11, 16 |
...
| `C-TEMPLATE-CARD` | Template and offer card | [00-product-overview.md](00-product-overview.md) | 10, 11 |
| `C-TILE-SELECT-ROW` | Single-select tile row | [00-product-overview.md](00-product-overview.md) | 14 |
| `C-TYPEAHEAD-PANEL` | Caret-anchored typeahead panel | [00-product-overview.md](00-product-overview.md) | 03, 09 |
...
**The two priority artifacts are complete; four area documents are outstanding and are named below.** This section is the catalog's single declared place for recording an omission, so it states what is verified and what is not, rather than what is hoped. The output priority order this run followed put the coverage ledger first and this master index second, then the in-product areas, then the marketing, pricing, brand and help areas — and it is the tail of that order that is outstanding, exactly as the priority rule intends. It separates what is verified, what is not yet delivered and what is absent by design, in that order and without conflating them.
...
- **Nineteen of the twenty-three workflow-area documents** — `00` through `16`, plus [`21-states.md`](21-states.md) and [`22-external-collaboration.md`](22-external-collaboration.md). Between them they own **750 of the 1,022 frames** across **173 of the 248 flows**, and each one's `Frames covered` set reconciles against the ledger's allocation for it.
...
The catalog is planned at **25 files** — these two plus the 23 workflow-area documents enumerated in the [index](#index-of-catalog-documents), whose per-area flow and frame allocations are already fixed and published in the ledger's [coverage assertion](_screenshot-index.md#coverage-assertion). **If any area document is ever delivered incomplete, or not delivered at all, it must be recorded here**, naming the document and the reason. Applying that policy to the present state: **23 of the 25 planned files are delivered** — this index, the ledger and 19 of the 23 area documents, covering **750 of the 1,022 frames** as primary owner. **Four area documents are outstanding**, and they are named here so their absence is a record rather than a gap: [`17-marketing-site.md`](17-marketing-site.md) (171 frames), [`18-pricing-plans.md`](18-pricing-plans.md) (26), [`19-brand-guidelines.md`](19-brand-guidelines.md) (9) and [`20-help-community.md`](20-help-community.md) (66) — 272 frames and 75 flows in total, every one of them already allocated in the ledger and awaiting its own document. Until they land, links to those four documents from elsewhere in the catalog resolve on the source host but not in the built site, and the roll-up's [Referenced by](#consolidated-component-inventory-roll-up) column carries no entry for them. Anything not listed above as verified should be confirmed against that allocation before it is relied on.

**Outstanding, recorded here as this section requires.** Four area documents are not yet written. Their flows, frame allocations and captions are already fixed and published in the ledger, so nothing about the corpus is unrecorded — what is missing is the behavioural specification built on top of that record. Until they are delivered, the ledger is the authority for those frames.

| Document | Frames allocated | Flows allocated | Consequence while outstanding |
|---|---|---|---|
| `17-marketing-site.md` | 171 | 48 | The largest outstanding allocation. Links to it from delivered documents do not resolve; the marketing surfaces are described only by their ledger captions |
| `18-pricing-plans.md` | 26 | 5 | The plan-comparison table's structure is unspecified beyond its ledger captions; `E-PLAN` therefore has no owning area document |
| `19-brand-guidelines.md` | 9 | 4 | The smallest outstanding allocation. The placeholder vocabulary in [`00-product-overview.md`](00-product-overview.md) already covers the substitution rule this area would apply |
| `20-help-community.md` | 66 | 18 | Help-article and community page structure is unspecified beyond its ledger captions |
| **Total** | **272** | **75** | 272 + 750 = 1,022 frames; 75 + 173 = 248 flows |

Two further consequences follow from those four, and both are stated rather than left to be discovered:

- **Cross-references into the four outstanding documents do not resolve.** Delivered documents legitimately cite them as the owners of surfaces they do not own themselves, so a documentation build reports one unresolved-link warning per citation — 276 for `17`, 129 for `20`, 78 for `18` and 17 for `19`. These are the *only* unresolved internal targets in the catalog; every other link resolves. They will clear when the documents are written, and they must not be "fixed" by removing the citations, because the ownership statements are correct.
...
Also verified complete: **19 of the 23 workflow-area documents** — [`00-product-overview.md`](00-product-overview.md) through [`16-files-media.md`](16-files-media.md), plus [`21-states.md`](21-states.md) and [`22-external-collaboration.md`](22-external-collaboration.md). Each follows the eleven-section template in order, carries at least one diagram, and claims a `Frames covered` set that reconciles exactly with the ledger's published primary-ownership allocation.
...
| [`18-pricing-plans.md`](18-pricing-plans.md) | Not yet authored. **5 flows over 26 primary frames**, allocated and published as above | Links to it do not resolve yet. `E-PLAN` is aggregated in the [consolidated data model](#consolidated-data-model) from the areas that observe it, but its owning area's field set is not yet written |
| [`19-brand-guidelines.md`](19-brand-guidelines.md) | Not yet authored. **4 flows over 9 primary frames**, allocated and published as above | Links to it do not resolve yet. The brand-page structure a build would rebuild with its own brand is not yet specified |
| [`20-help-community.md`](20-help-community.md) | Not yet authored. **18 flows over 66 primary frames**, allocated and published as above | Links to it do not resolve yet. The help-article and community-page information architecture is not yet specified |
...
**Union closure is therefore not yet verifiable as a whole.** The invariant — the union of every area's `Frames covered` set equals `{0 … 1021}` — needs all 23 areas. Nineteen reconcile exactly against the ledger today; the remaining four frames sets are allocated and published but unclaimed until their documents exist. The ledger's own [coverage assertion](_screenshot-index.md#coverage-assertion) states the same position.
