...
Closure requirement: **every `E-*` cited anywhere in the catalog appears in this table.** Thirty-five entities do — twenty from the in-product areas, fifteen from the public and commercial ones, and the split of the commercial set is a **security boundary rather than a modelling preference**: `E-PLAN` and `E-PROMOTION` are catalog objects that an unauthenticated visitor reads in full on the public pricing page, while a workspace's subscription, billing account, payment method, billing contacts, invoices and estimate each carry an explicit tenant key. Holding both populations in one record would make the read that serves a public page a read of tenant data.
...
| `E-BILLING-ACCOUNT` | [15](15-admin-workspace.md), [18](18-pricing-plans.md) | **Tenant scope — keyed by workspace.** billing address of organisation name, country or region, up to two address lines with the second optional, city, state and a postal code accepting an extended form, stated to appear on every invoice [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png), [frame 612](../../screenshots/Slack%20web%20Jul%202024%20612.png), [frame 613](../../screenshots/Slack%20web%20Jul%202024%20613.png), [frame 671](../../screenshots/Slack%20web%20Jul%202024%20671.png) · currency as a three-letter code with no control of its own [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png) · payment settlement mode, immediate or invoiced [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png) · billing-notification frequency [frame 671](../../screenshots/Slack%20web%20Jul%202024%20671.png) · purchase-authorization policy governing which accounts may purchase [frame 671](../../screenshots/Slack%20web%20Jul%202024%20671.png), [frame 672](../../screenshots/Slack%20web%20Jul%202024%20672.png) · discount-eligibility enquiry routed to the help centre [frame 669](../../screenshots/Slack%20web%20Jul%202024%20669.png). Governed by `S-PII` |
| `E-PAYMENT-METHOD` | [15](15-admin-workspace.md), [18](18-pricing-plans.md) | **Tenant scope — keyed by workspace.** kind, card or bank account [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png) · masked identifier, network, expiry and default flag [frame 674](../../screenshots/Slack%20web%20Jul%202024%20674.png), [frame 679](../../screenshots/Slack%20web%20Jul%202024%20679.png) — **and nothing more**, because `S-SECRET` forbids the instrument itself existing in application storage |
| `E-BILLING-CONTACT` | [15](15-admin-workspace.md), [18](18-pricing-plans.md) | **Tenant scope — keyed by workspace.** person, role and a correspondence-delivery preference, additional contacts being copied on all billing correspondence [frame 672](../../screenshots/Slack%20web%20Jul%202024%20672.png). Every field is personal contact data under `S-PII` |
| `E-INVOICE` | [15](15-admin-workspace.md), [18](18-pricing-plans.md) | **Tenant scope — keyed by workspace, append-only.** date, item label, optional statement reference, optional charge and optional status — a trial start being itself an entry with neither charge nor status [frame 670](../../screenshots/Slack%20web%20Jul%202024%20670.png) |
| `E-ESTIMATE` | [15](15-admin-workspace.md), [18](18-pricing-plans.md) | **Tenant scope — keyed by workspace, transient.** unit price, member count, period factor, line total, tax line, due-on date, total, currency, billing period and a qualifying statement that the figure will follow the member count on the renewal date [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png), [frame 615](../../screenshots/Slack%20web%20Jul%202024%20615.png), [frame 616](../../screenshots/Slack%20web%20Jul%202024%20616.png). **How the tax figure is derived is uncaptured**, and `S-GAP` governs it |
