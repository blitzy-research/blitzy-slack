...
- [ ] All 35 `C-*` components are implemented once as shared components matching their contracts in the **Shared component inventory** section of this document, and no shell surface re-implements one locally.
