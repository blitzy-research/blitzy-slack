...
- [ ] `E-USER`, `E-WORKSPACE` and `E-INVITATION` persist every field listed in the **Implied data model** section, and the invite link's nineteen-day expiry, a guest account's end date and the external-collaboration acceptance window are three separate fields on their own entities [frame 46](../../screenshots/Slack%20web%20Jul%202024%2046.png), [frame 54](../../screenshots/Slack%20web%20Jul%202024%2054.png).
- [ ] Marketing consent is stored per account with the observed per-surface default — off on sign-up, on when accepting an invitation — and never gates a primary action [frame 6](../../screenshots/Slack%20web%20Jul%202024%206.png), [frame 746](../../screenshots/Slack%20web%20Jul%202024%20746.png), [frame 748](../../screenshots/Slack%20web%20Jul%202024%20748.png).
