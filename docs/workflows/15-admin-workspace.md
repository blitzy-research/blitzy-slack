...
| Entity | Observed fields |
|---|---|
| `E-SUBSCRIPTION` | **Tenant scope — keyed by workspace.** the tier currently billed [frame 346](../../screenshots/Slack%20web%20Jul%202024%20346.png), [frame 600](../../screenshots/Slack%20web%20Jul%202024%20600.png) · billing period, a two-valued selection [frame 346](../../screenshots/Slack%20web%20Jul%202024%20346.png), [frame 616](../../screenshots/Slack%20web%20Jul%202024%20616.png) · trial state — active flag, length, absolute end date and a remaining duration in whole days whose singular and plural forms follow the value [frame 550](../../screenshots/Slack%20web%20Jul%202024%20550.png), [frame 566](../../screenshots/Slack%20web%20Jul%202024%20566.png), [frame 610](../../screenshots/Slack%20web%20Jul%202024%20610.png) · billable member count and renewal date [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png), [frame 616](../../screenshots/Slack%20web%20Jul%202024%20616.png) · resolved entitlement set, which is what makes a gate badge render beside one menu row and not its siblings [frame 500](../../screenshots/Slack%20web%20Jul%202024%20500.png), [frame 550](../../screenshots/Slack%20web%20Jul%202024%20550.png), [frame 700](../../screenshots/Slack%20web%20Jul%202024%20700.png) · applied promotion and its own remaining duration, distinct from the trial's [frame 203](../../screenshots/Slack%20web%20Jul%202024%20203.png), [frame 560](../../screenshots/Slack%20web%20Jul%202024%20560.png) |
...
| `E-PAYMENT-METHOD` | **Tenant scope — keyed by workspace.** kind, card or bank account [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png) · masked identifier, network, expiry and default flag [frame 674](../../screenshots/Slack%20web%20Jul%202024%20674.png), [frame 679](../../screenshots/Slack%20web%20Jul%202024%20679.png) — **and nothing more**, because `S-SECRET` forbids the instrument itself existing in application storage |
...
| `E-PLAN` | [18-pricing-plans.md](18-pricing-plans.md) | **Catalog scope only** — the tier a surface names and the capability-to-tier mapping an upgrade route advertises. Every workspace-specific value the billing surfaces render is contributed to the **tenant-scoped** `E-SUBSCRIPTION` and `E-PROMOTION` records in the table above rather than here: trial state with a through-date, the end-trial affordance's effect, the discount enquiry's outcome and a submitted promotional code's applied result are all tenant facts, and holding any of them on a publicly readable catalogue object would make the read that serves the public pricing page a read of tenant data [frame 669](../../screenshots/Slack%20web%20Jul%202024%20669.png) · a benefit set of six items lost if payment details are not recorded [frame 600](../../screenshots/Slack%20web%20Jul%202024%20600.png) · a per-capability entitlement expressed as a badge or as an upgrade action in place of a configure action [frame 577](../../screenshots/Slack%20web%20Jul%202024%20577.png), [frame 587](../../screenshots/Slack%20web%20Jul%202024%20587.png) · billing address of organisation name, country or region and street, stated to appear on every invoice [frame 671](../../screenshots/Slack%20web%20Jul%202024%20671.png) · billing contacts, each a person with a role and a delivery preference [frame 672](../../screenshots/Slack%20web%20Jul%202024%20672.png) · billing history entries, each a date, an item, a statement reference and optional charge and status values [frame 670](../../screenshots/Slack%20web%20Jul%202024%20670.png) · payment method of a kind, a masked identifier, a network, an expiry and a default flag [frame 679](../../screenshots/Slack%20web%20Jul%202024%20679.png) · a promotional code, validated on submission [frame 677](../../screenshots/Slack%20web%20Jul%202024%20677.png) · billing period, offered on the purchase page as a two-value disclosure reading monthly or yearly, each value carrying its own unit rate [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png), [frame 616](../../screenshots/Slack%20web%20Jul%202024%20616.png) · billing currency, rendered on the purchase page as a non-interactive three-letter pill [frame 611](../../screenshots/Slack%20web%20Jul%202024%20611.png) · the tier set itself, observed as three named paid tiers beside a comparison affordance [frame 601](../../screenshots/Slack%20web%20Jul%202024%20601.png) |
...
- [ ] A payment instrument is collected through **provider-served, provider-scripted fields**, so its number and security code never reach this product's scripts, servers or logs; the product holds **only** a provider token and provider reference plus the masked identifier, network, expiry and default flag, and **no stored value is ever rendered in full** on any surface, in any export or in any API response [frame 678](../../screenshots/Slack%20web%20Jul%202024%20678.png), [frame 679](../../screenshots/Slack%20web%20Jul%202024%20679.png), per `S-PAYMENT`.
